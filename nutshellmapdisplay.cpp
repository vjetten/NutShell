    ...
    if (drawMapType == 1)
    {
        ...
        if (drawMapType == 2)
        {
            ...
            if (drawMapType == 3)
            {
                ...
                if (drawMapType == 4)
                {
                    MPlot->setTitle(mapDisplayNames);
                    drawMap->setColorMap(new colorMapRedBlue());
                    RD->setInterval( Qt::ZAxis, QwtInterval( MinV, MaxV));
                }
    drawMap->setData(RD);
    ...
    if (drawMapType == 1)
    {
        ...
        if (drawMapType == 2)
        {
            ...
            if (drawMapType == 3)
            {
                ...
                if (drawMapType == 4)
                {
                    rightAxis->setColorMap( drawMap->data()->interval( Qt::ZAxis ), new colorMapRedBlue());
